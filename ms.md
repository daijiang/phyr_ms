...
pglmm(
  Y ~ trait * env +
    ...
    (1 | sp__@site),
  data = data,
  cov_randef = list(sp = phy.sp, site = V.space),
  family = 'binomial',
  bayes = FALSE,
  REML = TRUE
) 
...
## Random effects:
##                  Variance  Std.Dev
## 1|species        1.43e-01 0.378025
## 1|species__      6.79e-07 0.000824
## 1|site           2.43e-07 0.000493
## 1|site__         8.71e-06 0.002951
## envi|species     2.26e-06 0.001503
## envi|species__   3.91e-07 0.000625
## trait|site       1.13e-04 0.010640
## 1|species__@site 1.98e+00 1.406444
## residual         2.30e-01 0.479676
## 
## Fixed effects:
##             Value Std.Error Zscore  Pvalue    
## (Intercept) 0.951     0.382   2.49 0.01290 *  
## envi        1.088     0.320   3.40 0.00067 ***
## trait       2.344     4.353   0.54 0.59021    
## envi:trait  3.349     3.214   1.04 0.29753    
## ---
...
<img src="/Users/travis/build/daijiang/phyr_ms/designPlot.pdf" alt="(ref:designPlotCap)" width="100%" />
...
## trait_1_0            -0.0356  0.1914   -0.19    0.85    
## trait_2_0            -1.2361  1.4652   -0.84    0.40    
## trait_2_cov_trait_2   1.0510  0.0173   60.91  <2e-16 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
```
...
Develop interface to fit model with Stan via brm?
